...
os.environ["COHERE_API_KEY"] = 'qXZft7pSjSZ30KzATsaA51JVmuSyxPzO6DI9fmJM'
os.environ['GROQ_API_KEY'] = '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'
...
def main():
    ...
    st.markdown(
        ...
        <div style='text-align: center;'>
            <p >Made with ❤ by Dishant Bhatt </p>
        </div>
        """,
        unsafe_allow_html=True
    )
